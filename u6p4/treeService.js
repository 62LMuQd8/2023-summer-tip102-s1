...
// read CodePath's explanation: https://guides.codepath.org/compsci/Binary-Tree-Inorder-Traversal
//
export class TreeService {
    ...
    // typically used to get keys in ascending order for bst
    inorderTraversal() {
      let list = [];
      inorder(this.root);
      return list;
      function inorder(root) {
        // reached null node, return
        if (root === null) return;
        // visit left subtree
        inorder(root.left);
        // record key
